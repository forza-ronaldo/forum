        ...
        <div class="w-1/5 bg-gray-300 text-center p-6">
            ...
            <modal name="storeDiscussionModal" height="630">
                ...
                <form @submit.prevent="storeDiscussion">
                    ...
                    <button
                        class="bg-red-700 text-white py-2 px-4 rounded-full uppercase text-sm"
                        type="submit"
                    >
                        new discussion
                    </button>
            ...
            <ul>
                <li v-for="channel in channels.data" :key="channel.id">
                    <router-link  :to="{name:'showCategory',params:{channel:channel.title}}">
                        {{channel.title}}
                    </router-link>
                </li>
            </ul>
...
export default {
    ...
    methods: {
        ...
        storeDiscussion() {
            ...
            this.$store.dispatch("storeDiscussion", data);
